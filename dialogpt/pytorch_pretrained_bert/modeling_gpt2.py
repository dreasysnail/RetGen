...
class GPT2LMHead(nn.Module):
    ...
    def __init__(self, model_embeddings_weights, config, tied = True):
        super(GPT2LMHead, self).__init__()
        self.n_embd = config.n_embd
        self.set_embeddings_weights(model_embeddings_weights, tied)

    def set_embeddings_weights(self, model_embeddings_weights, tied = True):
...
class GPT2PreTrainedModel(nn.Module):
    ...
    @classmethod
    def from_pretrained(
        cls, pretrained_model_name_or_path, state_dict=None, cache_dir=None, from_tf=False, tied=True, *inputs, **kwargs
    ):
        """
...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def __init__(self, config, tied = True):
        super(GPT2LMHeadModel, self).__init__(config)
        self.transformer = GPT2Model(config)
        self.lm_head = GPT2LMHead(self.transformer.wte.weight, config, tied)
        self.apply(self.init_weights)
