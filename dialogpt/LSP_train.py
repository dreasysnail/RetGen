...
from env import TOKEN_TYPE_CXT, TOKEN_TYPE_DOC
...
parser.add_argument('--set_type_embedding_to_zero', type=boolean_string, default=False, help='turn on progress bar')
